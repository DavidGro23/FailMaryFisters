...
| D6 | **`matchup-history` points are authoritative.** Never recompute a team score from player stats. Measured across all nine seasons: **72 team-games** do not reconcile against the sum of their starters — 2017:6, 2018:9, 2019:7, 2020:8, 2021:5, 2022:9, 2023:11, 2024:15, 2025:2. **Every delta has the same sign** — the matchup file is always greater than or equal to the starter sum, never less — which is consistent with player records missing from the stats export rather than with scoring errors. Deltas are mostly round (2.00, 4.00, 6.00, 8.00) plus a few fractional ones (0.20, 0.36, 1.40). Two lineups carry one starter fewer than that season's slot count: `2017-15-2-3` (team 3) and `2024-14-3-5` (team 3). Mismatches go to the validation report; they never fail the build and never alter displayed scores. |
...
| 15 | Decide the display treatment for the 72 non-reconciling team-games (D6) on `/about/` — one summary line, or a full list | Stage 4 |
